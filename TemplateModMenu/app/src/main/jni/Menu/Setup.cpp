...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle)
{
    ...
    setText(env, subtitle,
            OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                      "<p style=\"color:green;\">Modded by mIsmanXP @ Platinmods.com</p> | "
                      "Menu by LGLTeam | <a href=\"https://github.com/LGLTeam\">https://github.com/LGLTeam</p>"
                      "</marquee></b>"));
    ...
    // Toast Example
    Toast(env, ctx, OBFUSCATE("Modded by mIsmanXP@Platinmods"), ToastLength::LENGTH_LONG);
