 ...
 * Compile with:
 *
 * clang -DANDROID -ffunction-sections -fdata-sections frida-gum-example.c -o frida-gum-example -L. -lfrida-gum -llog -ldl -lm -pthread -Wl,-z,relro,-z,noexecstack,--gc-sections
 *
